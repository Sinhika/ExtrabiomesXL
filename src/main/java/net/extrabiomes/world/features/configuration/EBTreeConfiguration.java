...
public class EBTreeConfiguration implements FeatureConfiguration
{
    ...
    public static final Codec<EBTreeConfiguration> CODEC = RecordCodecBuilder.create( (p_codec) -> {
        ...
        }), BlockStateProvider.CODEC.fieldOf("branch_provider").forGetter((p_dp) -> {
            return p_dp.branch_provider;
    ...
    public final BlockStateProvider branch_provider;
    public final int base_height;
    public final int base_height_variance;

    public EBTreeConfiguration(BlockStateProvider log, BlockStateProvider leaves, BlockStateProvider branch,
                               int min_size, int size_variation)
    {
        this.trunk_provider = log;
        this.foliage_provider = leaves;
        this.branch_provider = branch;
